...
if not os.path.exists(DB_FILE):
    ...
    # --- [섹션 5: 결론 및 정책 제언] ---
        ...
        **(3) 사고 예방 정책**
        ...
        김용렬, 이정민, 우성휘 (2019). 고령 운전자 운전면허 관리 강화에 대한 농촌의 의견. KREI 현안분석, 제62호, 한국농촌경제연구원. 
        https://www.krei.re.kr/attach/pdf/PRI062.pdf
        
        도로교통공단 (2020). 연령대별 가해운전자 교통사고 통계. 교통사고분석시스템(TAAS).
        
        도로교통공단 (2025). "고령운전자도 '운전능력 평가 강화' 원한다" - 공단 인식조사 결과 보도자료. (2025. 05. 15). 
        https://www.koroad.or.kr/main/board/6/302823/board_view.do
