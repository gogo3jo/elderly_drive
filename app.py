...
if not os.path.exists(DB_FILE):
    ...
    # --- [섹션 5: 결론 및 정책 제언] ---
        ...
        **(3) 사고 예방 정책**
        ...
        1. 경찰청 (2020). 운전면허소지자 연령별 현황(2020년 12월 말 기준). 공공데이터포털.
        2. 김용렬, 이정민, 우성휘 (2019). 고령 운전자 운전면허 관리 강화에 대한 농촌의 의견. KREI 현안분석, 제62호, 한국농촌경제연구원. https://www.krei.re.kr/attach/pdf/PRI062.pdf
        3. 도로교통공단 (2020). 연령대별 가해운전자 교통사고 통계. 교통사고분석시스템(TAAS).
        4. 도로교통공단 (2025). "고령운전자도 '운전능력 평가 강화' 원한다" - 공단 인식조사 결과 보도자료. (2025. 05. 15). https://www.koroad.or.kr/main/board/6/302823/board_view.do
        5. 통계청 (2024). 시도별 고령인구비율. KOSIS 국가통계포털.
        6. 한국교통안전공단 (2024). 시도별 대중교통 이용인원. 교통카드 빅데이터 통합정보시스템.
        7. 한국사회과학자료원 (2017). 노인인권에 대한 인식 및 실태조사: 청장년. KOSSDA.
        8. 행정안전부 (2024). 시도 경찰청별 고령운전자 자진반납 현황. 공공데이터포털.
        """)
        st.balloons()